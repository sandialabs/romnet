...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH, ROMNet_fld):
        ...
        self.path_to_run_fld        = self.ROMNet_fld   + '/../0DReact_Isobaric_500Cases_Up_PCA_'+PCA_NAME+'_Branch/'           # Path To Training Folder
        ...
        self.path_to_data_fld       = self.ROMNet_fld   + '/../Data/0DReact_Isobaric_500Cases_Up/'+str(self.NRODs)+'PC/OneByOne/PCA_'+PCA_NAME+'/Branch/'           # Path To Training Data Folder 
        ...
        self.ProbApproach        = 'Deterministic'                                                        # Probabilistic Technique for Training the BNN (if Any)
        self.InputVars           = ['PC_'+str(iPC+1) for iPC in range(self.NRODs)]                                                                 # List Containing the Input Data Column Names 
        self.OutputVars          = ['PCA_'+str(i_mode+1) for i_mode in range(self.n_modes)]+['C','D']                                                              # List Containing the Output Data Column Names
        self.TransFun            = None#{'log': ['t']} 
        self.NormalizeInput      = True                                                                   # Flag for Normalizing Input Data
