...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH):
        ...
        self.path_to_run_fld     = self.ROMNet_fld + '/../StiffKinetics_500Cases/'                            # Path To Training Folder
        ...
        #=======================================================================================================================================
        ### Physical System
        self.phys_system         = 'StiffKinetics'                                                           # Name of the Physical System for PINN
        ...
        ## Physics Informed
        self.n_train             = {'pts': 0, 'res': 0}                                                      # Type/No of Data Points
        ...
        self.path_to_data_fld    = self.ROMNet_fld   + '/../Data/StiffKinetics_500Cases/Orig/'                # Path To Training Data Folder 
        self.Vars  = ['s1','s2','s3']
        Vars0      = []
        for Var in self.Vars:
            Vars0.append(str(Var)+'0')
        self.Vars0 = Vars0
        self.Vars0 = self.Vars
        ...
        ## Physics Informed
        self.losses              = {'pts': {'name': 'MSE', 'axis': 0}, 'res': {'name': 'MSE', 'axis': 0}}    # Dictionary Containing Loss Functions for Each Data Type
        self.loss_weights        = {'pts': 1., 'res': 1.e-5}                                                 # Dictionary Containing Weights for Each Data Type
        ...
        self.batch_size          = 2024                                                                       # Mini-Batch Size
        self.valid_batch_size    = 2024                                                                       # Validation Mini-Batch Size
        self.lr                  = 5.e-4                                                                     # Initial Learning Rate
        self.lr_decay            = ["exponential", 5000, 0.92]                                              # Instructions for Learning Rate Decay
