...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH):
        ...
        self.path_to_run_fld     = self.ROMNet_fld + '/../Rect_50Instants_RotTrans/'                              # Path To Training Folder
        ...
        self.path_to_data_fld    = self.ROMNet_fld + '/../Data/Rect_50Instants_RotTrans/Orig/'                           # Path To Training-Data Folder 
        ...
        self.n_neurons           = {'DeepONet': {'Branch': {'Main': np.array([8,8,self.n_branch_out])},
                                                  'Shift': {'Main': np.array([32,32,32,4])},  
                                               'Rotation': {'Main': np.array([32,32,32,4])},  
