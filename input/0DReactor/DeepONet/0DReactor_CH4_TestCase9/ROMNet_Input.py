...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH):
        ...
        self.path_to_run_fld     = self.ROMNet_fld + '/../0DReact_Isobaric_500Cases_CH4_Autoencoded/'                       # Path To Training Folder
        ...
        # -----------------------------------------------------------------------------------
        self.ROM_type            = 'Autoencoder'
        self.path_to_data_fld    = self.ROMNet_fld   + '/../Data/0DReact_Isobaric_500Cases_CH4_/10Autoencoded_LIN/'                # Path To Training Data Folder 
