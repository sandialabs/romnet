...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH):
        ...
        self.n_neurons           = {'DeepONet': {'Branch': {'Main': np.array([40,40,40,40,40,self.n_branch_out])},  
                                                'Stretch': {'Main': np.array([16,16,16,16,16,self.n_trunks])},
                                                  'Trunk': {'Main': np.array([40,40,40,40,40,self.n_trunk_out])}}} # Dictionary Containing the No of Neurons for each Layer
        self.act_funcs           = {'DeepONet': {'Branch': {'Main': ['tanh','tanh','tanh','tanh','tanh','linear']},  
                                                'Stretch': {'Main': ['tanh','tanh','tanh','tanh','tanh','softplus']},
