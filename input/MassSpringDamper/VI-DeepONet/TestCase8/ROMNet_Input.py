...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH):
        ...
        self.path_to_run_fld     = self.ROMNet_fld + '/../MSD_50Cases_wNoise_5em2t/'                                 # Path To Training Folder
        ...
        self.layer_type          = {'DeepONetMean': {'Branch': {'Main': ['TFP','TFP','TFP','TFP']},  
                                    ...
                                    'DeepONetSD':   {'Branch': {'Main': ['TFP','TFP','TFP','TFP']},  
        ...
        self.lr_decay            = ["exponential", 1000, 0.94]                                              # Instructions for Learning Rate Decay
