...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH):
        ...
        self.path_to_load_fld    = self.ROMNet_fld + '/../Data/MSD_100Cases/Orig/OneByOne/FNN/Final.h5'      # Path To Pre-Trained Model Folder 
        ...
        #=======================================================================================================================================
        ### Training Quanties
        self.trainable_flg       = {'DeepONet': 'none'}                                                      # Dictionary Containing Instructions for Training Components ('all'/'none'/'only_last')
