...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH):
        ...
        self.n_modes             = 100                                                                        # No of Modes (i.e., No of Neurons in Trunk's Last Layer)
        ...
        self.path_to_run_fld     = self.ROMNet_fld + '/../Advection_10Cases/'                       # Path To Training Folder
        ...
        self.path_to_data_fld    = self.ROMNet_fld   + '/../Data/Advection_10Cases/Orig/'                # Path To Training Data Folder 
        self.Vars0               = ['u'+str(ix+1) for ix in range(self.Nx)]

        self.output_vars         = ['s']                                                 # List Containing the Output Data Variable Names for each System
        self.input_vars_all      = self.Vars0 + ['t'] + ['x']                                                                    # List Containing all the Input Data Variable Names
        self.input_vars          = {'DeepONet': {'Branch': self.Vars0,
                                                  'Trunk': ['t','x']}}                                                       # Dictionary Containing the Input  Data Variable Names for each Component
        self.n_branches          = 1
        self.n_trunks            = 1
        # -----------------------------------------------------------------------------------
        ...
        self.n_neurons           = {'DeepONet': {'Branch': {'Main': np.array([100,100,100,100,self.n_branch_out])},  
                                                  'Trunk': {'Main': np.array([100,100,100,100,self.n_trunk_out])}}} # Dictionary Containing the No of Neurons for each Layer
        ...
        self.batch_size          = 100                                                                       # Mini-Batch Size
        self.valid_batch_size    = 100                                                                       # Validation Mini-Batch Size
