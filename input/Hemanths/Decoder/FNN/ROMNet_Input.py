...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH):
        ...
        self.path_to_data_fld    = self.ROMNet_fld   + '/../Data/Hemanths/8PC/ROM/Decoder/'                # Path To Training Data Folder 
        self.path_to_run_fld     = self.ROMNet_fld + '/../Hemanths_Test/'                       # Path To Training Folder
        ...
        self.gaussnoise_rate     = {'FNN': {'FNN': 1.e-4}}                                                   # Dictionary Containing Flags for Normalizing Input Data for each Component
        ...
        self.n_neurons           = {'FNN': {'FNN': {'Main': np.array([12,15,20,self.n_outputs,self.n_outputs])}}}           # Dictionary Containing the No of Neurons for each Layer
        self.act_funcs           = {'FNN': {'FNN': {'Main': ['tanh','tanh','tanh','tanh','softplus']}}}               # Dictionary Containing the Activation Funct.s for each Layer
        ...
        self.batch_size          = 2048                                                                        # Batch Size for Training
        self.valid_batch_size    = 2048                                                                       # Batch Size for Validation
