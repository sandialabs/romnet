...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH):
        ...
        self.path_to_run_fld     = self.ROMNet_fld + '/../BigBubble_Test/'                            # Path To Training Folder
        ...
        # -----------------------------------------------------------------------------------
        self.path_to_data_fld    = self.ROMNet_fld + '/../Data/BigBubble_Test/Orig/' # Path To Training-Data Folder  
        
        theta_vars               = ['theta_'+str(i+1) for i in range(4)]
        w_vars                   = ['w_'+str(i+1) for i in range(10)]
        x_vars                   = ['x_'+str(i+1) for i in range(10)]
        y_vars                   = ['y_'+str(i+1) for i in range(10)]
        self.output_vars         = w_vars+x_vars+y_vars                                                 # List Containing the Output Data Variable Names for each System
        self.input_vars_all      = theta_vars+['t']                                                 # List Containing all the Input Data Variable Names
        self.input_vars          = {'DeepONet': {'Branch': theta_vars,
