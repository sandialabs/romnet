...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH, ROMNet_fld):
        ...
        self.path_to_run_fld        = self.ROMNet_fld   + '/../0DReact_Isobaric_100Cases_PCA_'+PCA_NAME+'_Trunk/'           # Path To Training Folder
        self.path_to_load_fld       = None                                                                   # Path To Pre-Trained Model Folder
        self.path_to_data_fld       = self.ROMNet_fld   + '/../Data/0DReact_Isobaric_100Cases_PCA/'+str(self.NRODs)+'PC/OneByOne/PCA_'+PCA_NAME+'/Trunk/'           # Path To Training Data Folder 
