...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH):
        ...
        self.i_red                = 1                                                                        # Index of the Reduced Variable of Interest
        run_id                    = str(self.i_red) #'All'                                                   # Run Identification ('All'/str(self.i_red))
        ...
        self.path_to_run_fld      = self.ROMNet_fld + '/../MSD_100Cases_PCA_'+run_id+'_Trunk/'                     # Path To Training Folder
        self.path_to_load_fld     = None                                                                           # Path To Pre-Trained Model Folder
        # self.path_to_load_fld     = self.ROMNet_fld + '/../Data/MSD_100Cases/Orig/OneByOne/PCA_'+run_id+'/Trunk/'  # Path To Pre-Trained Model Folder
        self.path_to_data_fld     = self.ROMNet_fld + '/../Data/MSD_100Cases/Orig/OneByOne/PCA_'+run_id+'/Trunk/'  # Path To Training-Data Folder 
        # self.path_to_data_fld     = self.ROMNet_fld + '/../Data/MSD_100Cases/Orig/All/PCA_'+run_id+'/Trunk/'       # Path To Training-Data Folder 
        ...
        ### Physics Informed
        # self.n_train              = {'ics': 64, 'res': 128}                                                  # Type/No of Data Points
        ...
        self.weight_decay_coeffs = np.array([1.e-5, 1.e-5], dtype=np.float64)                                # Hyperparameters for L1 and L2 Weight Decay Regularizations
        self.callbacks_dict      = {
            'base': {
