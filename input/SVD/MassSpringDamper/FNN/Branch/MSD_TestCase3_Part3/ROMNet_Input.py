...
class inputdata(object):
    ...
    def __init__(self, WORKSPACE_PATH):
        ...
        self.path_to_run_fld      = self.ROMNet_fld + '/../MSD_100Cases_PCA_'+run_id+'_Branch_'+str(self.i_red)+'/'               # Path To Training Folder
        self.path_to_load_fld     = None                                                                                          # Path To Pre-Trained Model Folder
        # self.path_to_load_fld     = self.ROMNet_fld + '/../Data/MSD_100Cases/Orig/OneByOne/PCA_'+run_id+'/Branch/'                # Path To Pre-Trained Model Folder
        self.path_to_data_fld     = self.ROMNet_fld + '/../Data/MSD_100Cases/Orig/OneByOne/PCA_'+run_id+'/Branch/'                # Path To Training-Data Folder  
        # self.path_to_data_fld     = self.ROMNet_fld + '/../Data/MSD_100Cases/Orig/All/PCA_'+run_id+'/Branch_'+str(self.i_red)+'/' # Path To Training-Data Folder  
        ...
        self.valid_batch_size    = 16                                                                        # Batch Size for Validation
